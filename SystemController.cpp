    ...
    do
    {
            ...
            if (id_found == true)
            {
                ...
                else if (field == 3)
                {
                    while (true)
                    {
                        ...
                        cin >> new_addr;
                        if (p.Is_Valid_Address(new_addr))
                            break;
                ...
                else if (field == 5)
                {
                    while (true)
                    {
                        ...
                        cin >> new_contact;
                        if (p.isValidContact(new_contact))
                            break;
                ...
                else if (field == 9)
                {
                    while (true)
                    {
                        ...
                        cin >> new_type;
                        if (p.isValidPatientType(new_type))
                            break;
                        cout << "Invalid type.\n";
                    }
        ...
        else if (choice == 5)
        {
            ...
            while (true)
            {
                ...
                cin >> status;
                if (s.isValidEmploymentStatus(status))
                    break;
                cout << "Invalid status.\n";
            }
                ...
                else
                {
                    ...
                    else if (field == 3)
                    {
                        while (true)
                        {
                            cout << "Enter new Address: ";
                            cin >> new_addr;
                            if (s.Is_Valid_Address(new_addr))
                                break;
                            cout << "Invalid Address.\n";
                        }
                    ...
                    else if (field == 5)
                    {
                        while (true)
                        {
                            ...
                            cin >> new_dept;
                            if (s.isValidDepartment(new_dept))
                                break;
                            cout << "Invalid Department.\n";
                        }
                    ...
                    else if (field == 9)
                    {
                        while (true)
                        {
                            ...
                            cin >> new_status;
                            if (s.isValidEmploymentStatus(new_status))
                                break;
                ...
                else
                {
                    ...
                    else if (field == 3)
                    {
                        while (true)
                        {
                            cout << "Enter new Address: ";
                            cin >> new_addr;
                            if (d.Is_Valid_Address(new_addr))
                                break;
                            cout << "Invalid Address.\n";
                        }
                        personChanged = true;
                    ...
                    else if (field == 5)
                    {
                        while (true)
                        {
                            ...
                            cin >> new_spec;
                            if (d.isValidSpecialization(new_spec))
                                break;
                    ...
                    else if (field == 6)
                    {
                        while (true)
                        {
                            ...
                            cin >> new_qual;
                            if (d.isValidQualification(new_qual))
                                break;
                    ...
                    else if (field == 7)
                    {
                        ...
                        while (true)
                        {
                            ...
                            cin >> new_exp;
                            if (d.isValidExperience(new_exp, new_age))
                                break;
                    ...
                    else if (field == 10)
                    {
                        while (true)
                        {
                            ...
                            cin >> new_status;
                            if (d.isValidAvailabilityStatus(new_status))
                                break;
                            cout << "Invalid Status.\n";
                        }
                        doctorChanged = true;
        ...
        {
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        if (!a.dateIsNotAPastDate(apptDate))
                            break;
                    ...
                    else
                    {
...

                        {
                            ...
                            for (char &c : enteredDayLower)
                                c = tolower(c);
                            for (char &c : availDayLower)
                                c = tolower(c);
                        ...
                        else
                        {
                            ...
                            auto convertTo24 = [](string t) -> int
                            {
                                ...
                                if (t.find("PM") != string::npos && hour != 12)
                                    hour += 12;
                                if (t.find("AM") != string::npos && hour == 12)
                                    hour = 0;
                                return hour;
                            };
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            cin >> cancelChoice;
                            if (cancelChoice >= 1 && cancelChoice <= apptCount)
                                break;
                            cout << "Invalid selection. Try again.\n";
                        }
